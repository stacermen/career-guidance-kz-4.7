...
const FAQ = [
  ...
  },
  {
    ...
    a: "После расчёта баллов мы отправляем структурированный профиль в Anthropic Claude (claude-sonnet-4-20250514). Он генерирует развёрнутый персональный комментарий и список карьерных направлений.",
  },
  {
